      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="lg:w-1/2 space-y-8">
            <div className="inline-block px-4 py-1.5 rounded-full border border-[#ff3d00]/30 bg-[#ff3d00]/5 text-[#ff3d00] text-[10px] font-black uppercase tracking-[0.2em] mb-4">
            ...
            <p className="text-white/50 text-lg md:text-xl leading-relaxed max-w-xl font-medium">
          ...
          <div className="lg:w-1/2 relative h-[500px] w-full flex items-center justify-center">
            ...
            <div className="relative w-full max-w-lg h-full flex items-center">
              ...
              <div className="absolute left-0 z-30 w-[280px] md:w-[320px] aspect-[3/4] rounded-3xl border border-[#ff3d00]/30 bg-gradient-to-br from-[#0a0402] to-black shadow-[0_30px_100px_rgba(255,61,0,0.1)] p-8 flex flex-col items-center justify-center text-center">
                ...
                <div className="relative mb-8">
                  <svg className="w-36 h-36 transform -rotate-90">
                    ...
                    <circle
                      ...
                      strokeWidth="12"
                      strokeDasharray="377"
                      strokeDashoffset="105" // Approx 72%
                      strokeLinecap="round"
                    />
                  </svg>
              ...
              <div className="absolute right-0 top-1/2 -translate-y-1/2 z-20 w-[260px] md:w-[300px] aspect-[3/4] rounded-3xl border border-white/10 bg-[#050505] p-5 shadow-2xl scale-95 origin-right translate-x-4 opacity-90 overflow-hidden">
              ...
              <div className="absolute right-[-80px] top-1/2 -translate-y-1/2 z-10 w-[260px] aspect-[3/4] rounded-3xl border border-white/5 bg-transparent opacity-20 scale-90 translate-x-12 overflow-hidden pointer-events-none">
